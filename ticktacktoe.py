...
def switch(r):
    ...
    if r11["text"] == "X" and r21["text"] == "X" and r31["text"] == "X" or r12["text"] == "X" and r22["text"] == "X" and r32["text"] == "X" or r13["text"] == "X" and r23["text"] == "X" and r33["text"] == "X" or r11["text"] == "X" and r12["text"] == "X" and r13["text"] == "X" or r21["text"] == "X" and r22["text"] == "X" and r23["text"] == "X" or r31["text"] == "X" and r32["text"] == "X" and r33["text"] == "X" or r11["text"] == "X" and r22["text"] == "X" and r33["text"] == "X" or r31["text"] == "X" and r22["text"] == "X" and r13["text"] == "X" :
        window.withdraw()
        winnerscreen("X.")
    if r11["text"] == "O" and r21["text"] == "O" and r31["text"] == "O" or r12["text"] == "O" and r22["text"] == "O" and r32["text"] == "O" or r13["text"] == "O" and r23["text"] == "O" and r33["text"] == "O" or r11["text"] == "O" and r12["text"] == "O" and r13["text"] == "O" or r21["text"] == "O" and r22["text"] == "O" and r23["text"] == "O" or r31["text"] == "O" and r32["text"] == "O" and r33["text"] == "O" or r11["text"] == "O" and r22["text"] == "O" and r33["text"] == "O" or r31["text"] == "O" and r22["text"] == "O" and r13["text"] == "O" :
        window.withdraw()
        winnerscreen("O.")
    elif count == 9:
        window.withdraw()
